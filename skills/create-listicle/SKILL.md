...
2. [Curate list](2-curate-list/)
3. [Outline](3-outline/)
4. [Draft](4-draft/)
5. [Finalize](5-finalize/)

**Inputs:** topic (required), count (default 10), audience (default general), word_count (default 1500). Resolve from $ARGUMENTS; replace placeholders in step instructions.
