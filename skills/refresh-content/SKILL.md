...
3. [Competitive check](3-competitive-check/)
4. [Refresh plan](4-refresh-plan/)
5. [Execute](5-execute/)
6. [Finalize](6-finalize/)

**Inputs:** source (required), depth (optional: quick, standard, deep). Resolve from $ARGUMENTS; replace `{source}`, `{depth}` in step instructions.
